...
namespace Openfort.SDK.Wrapper
{
    public class OAuthApiWrapper: BaseApiWrapper
    {
        ...
        public async Task<PlayerResponse> GetPlayerByExternalId(GetPlayerByExternalIdRequest request) => await apiClient.GetPlayerByExternalIdAsync(request.Provider, request.ExternalId);

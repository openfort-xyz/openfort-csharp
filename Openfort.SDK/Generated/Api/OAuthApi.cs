...
namespace Openfort.SDK.Api
{
    ...
    public partial class OAuthApi : IDisposable, IOAuthApi
    {
        ...
        {
            Openfort.SDK.Client.ApiResponse<AuthorizeWithOAuthToken200Response> localVarResponse = AuthorizeWithOAuthTokenWithHttpInfo(provider, oAuthRequest);
        ...
        public Openfort.SDK.Client.ApiResponse<AuthorizeWithOAuthToken200Response> AuthorizeWithOAuthTokenWithHttpInfo(OAuthProvider provider, OAuthRequest oAuthRequest)
        {
            ...
            if (oAuthRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'oAuthRequest' when calling OAuthApi->AuthorizeWithOAuthToken");
        ...
        {
            Openfort.SDK.Client.ApiResponse<AuthorizeWithOAuthToken200Response> localVarResponse = await AuthorizeWithOAuthTokenWithHttpInfoAsync(provider, oAuthRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<AuthorizeWithOAuthToken200Response>> AuthorizeWithOAuthTokenWithHttpInfoAsync(OAuthProvider provider, OAuthRequest oAuthRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<AuthorizeWithOAuthToken200Response>("/iam/v1/oauth/{provider}/authorize", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Openfort.SDK.Client.ApiResponse<PlayerResponse> localVarResponse = GetPlayerByExternalIdWithHttpInfo(provider, externalUserId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="externalUserId">External user id</param>
        /// <returns>ApiResponse of PlayerResponse</returns>
        public Openfort.SDK.Client.ApiResponse<PlayerResponse> GetPlayerByExternalIdWithHttpInfo(OAuthProvider provider, string externalUserId)
        {
            // verify the required parameter 'externalUserId' is set
            if (externalUserId == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'externalUserId' when calling OAuthApi->GetPlayerByExternalId");
        ...
        {
            Openfort.SDK.Client.ApiResponse<PlayerResponse> localVarResponse = await GetPlayerByExternalIdWithHttpInfoAsync(provider, externalUserId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PlayerResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<PlayerResponse>> GetPlayerByExternalIdWithHttpInfoAsync(OAuthProvider provider, string externalUserId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'externalUserId' is set
            if (externalUserId == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'externalUserId' when calling OAuthApi->GetPlayerByExternalId");
        ...
        {
            Openfort.SDK.Client.ApiResponse<PlayerResponse> localVarResponse = VerifyOAuthTokenWithHttpInfo(provider, oAuthRequest);
            return localVarResponse.Data;
        }
        ...
        public Openfort.SDK.Client.ApiResponse<PlayerResponse> VerifyOAuthTokenWithHttpInfo(OAuthProvider provider, OAuthRequest oAuthRequest)
        {
            // verify the required parameter 'oAuthRequest' is set
            if (oAuthRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'oAuthRequest' when calling OAuthApi->VerifyOAuthToken");
        ...
        {
            Openfort.SDK.Client.ApiResponse<PlayerResponse> localVarResponse = await VerifyOAuthTokenWithHttpInfoAsync(provider, oAuthRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

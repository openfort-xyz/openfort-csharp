...
namespace Openfort.SDK.Api
{
    ...
    public partial class Web3ConnectionsApi : IDisposable, IWeb3ConnectionsApi
    {
        ...
        /// <returns></returns>
        public Web3ConnectionsApi(Openfort.SDK.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public Web3ConnectionsApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public Web3ConnectionsApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public Web3ConnectionsApi(HttpClient client, Openfort.SDK.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public Web3ConnectionsApi(Openfort.SDK.Client.ISynchronousClient client, Openfort.SDK.Client.IAsynchronousClient asyncClient, Openfort.SDK.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> localVarResponse = CreateWeb3ConnectionWithHttpInfo(createWeb3ConnectionRequest);
        ...
        /// <param name="createWeb3ConnectionRequest"></param>
        /// <returns>ApiResponse of Web3ConnectionResponse</returns>
        public Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> CreateWeb3ConnectionWithHttpInfo(CreateWeb3ConnectionRequest createWeb3ConnectionRequest)
        {
            // verify the required parameter 'createWeb3ConnectionRequest' is set
            if (createWeb3ConnectionRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'createWeb3ConnectionRequest' when calling Web3ConnectionsApi->CreateWeb3Connection");
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> localVarResponse = await CreateWeb3ConnectionWithHttpInfoAsync(createWeb3ConnectionRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Web3ConnectionResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse>> CreateWeb3ConnectionWithHttpInfoAsync(CreateWeb3ConnectionRequest createWeb3ConnectionRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createWeb3ConnectionRequest' is set
            if (createWeb3ConnectionRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'createWeb3ConnectionRequest' when calling Web3ConnectionsApi->CreateWeb3Connection");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Web3ConnectionResponse>("/v1/web3_connections", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ActionListResponse> localVarResponse = GetWeb3ActionsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public Openfort.SDK.Client.ApiResponse<Web3ActionListResponse> GetWeb3ActionsWithHttpInfo(string id)
        {
            ...
            if (id == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling Web3ConnectionsApi->GetWeb3Actions");
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ActionListResponse> localVarResponse = await GetWeb3ActionsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Web3ActionListResponse>> GetWeb3ActionsWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Web3ActionListResponse>("/v1/web3_connections/{id}/actions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> localVarResponse = GetWeb3ConnectionWithHttpInfo(id, expand);
            return localVarResponse.Data;
        }
        ...
        /// <param name="expand">Specifies the fields to expand. (optional)</param>
        /// <returns>ApiResponse of Web3ConnectionResponse</returns>
        public Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> GetWeb3ConnectionWithHttpInfo(string id, List<Web3ConnectionResponseExpandable> expand = default(List<Web3ConnectionResponseExpandable>))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling Web3ConnectionsApi->GetWeb3Connection");
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse> localVarResponse = await GetWeb3ConnectionWithHttpInfoAsync(id, expand, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Web3ConnectionResponse>> GetWeb3ConnectionWithHttpInfoAsync(string id, List<Web3ConnectionResponseExpandable> expand = default(List<Web3ConnectionResponseExpandable>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Web3ConnectionResponse>("/v1/web3_connections/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Web3ConnectionListResponse>> GetWeb3ConnectionsWithHttpInfoAsync(string player, int? limit = default(int?), int? skip = default(int?), SortOrder? order = default(SortOrder?), bool? disconnected = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Web3ConnectionListResponse>("/v1/web3_connections", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ActionResponse> localVarResponse = SubmitWeb3ActionWithHttpInfo(id, web3Action, submitWeb3ActionRequest);
            return localVarResponse.Data;
        }
        ...
        public Openfort.SDK.Client.ApiResponse<Web3ActionResponse> SubmitWeb3ActionWithHttpInfo(string id, string web3Action, SubmitWeb3ActionRequest submitWeb3ActionRequest)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling Web3ConnectionsApi->SubmitWeb3Action");

            // verify the required parameter 'web3Action' is set
            if (web3Action == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'web3Action' when calling Web3ConnectionsApi->SubmitWeb3Action");

            // verify the required parameter 'submitWeb3ActionRequest' is set
            if (submitWeb3ActionRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'submitWeb3ActionRequest' when calling Web3ConnectionsApi->SubmitWeb3Action");
            ...
            localVarRequestOptions.PathParameters.Add("id", Openfort.SDK.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("web3_action", Openfort.SDK.Client.ClientUtils.ParameterToString(web3Action)); // path parameter
        ...
        {
            Openfort.SDK.Client.ApiResponse<Web3ActionResponse> localVarResponse = await SubmitWeb3ActionWithHttpInfoAsync(id, web3Action, submitWeb3ActionRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Web3ActionResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Web3ActionResponse>> SubmitWeb3ActionWithHttpInfoAsync(string id, string web3Action, SubmitWeb3ActionRequest submitWeb3ActionRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling Web3ConnectionsApi->SubmitWeb3Action");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Web3ActionResponse>("/v1/web3_connections/{id}/actions/{web3_action}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

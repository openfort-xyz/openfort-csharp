...
namespace Openfort.SDK.Api
{
    ...
    public partial class PlayersAuthenticationApi : IDisposable, IPlayersAuthenticationApi
    {
        ...
        /// <returns></returns>
        public PlayersAuthenticationApi(Openfort.SDK.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public PlayersAuthenticationApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PlayersAuthenticationApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PlayersAuthenticationApi(HttpClient client, Openfort.SDK.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public PlayersAuthenticationApi(Openfort.SDK.Client.ISynchronousClient client, Openfort.SDK.Client.IAsynchronousClient asyncClient, Openfort.SDK.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Openfort.SDK.Client.ApiResponse<AuthPlayerListResponse> localVarResponse = GetAuthenticatedPlayersWithHttpInfo(limit, skip, order, email);
        ...
        /// <param name="email">Specifies the email address of the user. (optional)</param>
        /// <returns>ApiResponse of AuthPlayerListResponse</returns>
        public Openfort.SDK.Client.ApiResponse<AuthPlayerListResponse> GetAuthenticatedPlayersWithHttpInfo(int? limit = default(int?), int? skip = default(int?), SortOrder? order = default(SortOrder?), string email = default(string))
        {
        ...
        {
            Openfort.SDK.Client.ApiResponse<AuthPlayerListResponse> localVarResponse = await GetAuthenticatedPlayersWithHttpInfoAsync(limit, skip, order, email, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthPlayerListResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<AuthPlayerListResponse>> GetAuthenticatedPlayersWithHttpInfoAsync(int? limit = default(int?), int? skip = default(int?), SortOrder? order = default(SortOrder?), string email = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Openfort.SDK.Client.ApiResponse<RegisterPlayerEncryptedKeyResponse> localVarResponse = RegisterKeyWithHttpInfo(registerPlayerEncryptedKeyRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="registerPlayerEncryptedKeyRequest"></param>
        /// <returns>ApiResponse of RegisterPlayerEncryptedKeyResponse</returns>
        public Openfort.SDK.Client.ApiResponse<RegisterPlayerEncryptedKeyResponse> RegisterKeyWithHttpInfo(RegisterPlayerEncryptedKeyRequest registerPlayerEncryptedKeyRequest)
        {
            // verify the required parameter 'registerPlayerEncryptedKeyRequest' is set
            if (registerPlayerEncryptedKeyRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'registerPlayerEncryptedKeyRequest' when calling PlayersAuthenticationApi->RegisterKey");
        ...
        {
            Openfort.SDK.Client.ApiResponse<RegisterPlayerEncryptedKeyResponse> localVarResponse = await RegisterKeyWithHttpInfoAsync(registerPlayerEncryptedKeyRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RegisterPlayerEncryptedKeyResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<RegisterPlayerEncryptedKeyResponse>> RegisterKeyWithHttpInfoAsync(RegisterPlayerEncryptedKeyRequest registerPlayerEncryptedKeyRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'registerPlayerEncryptedKeyRequest' is set
            if (registerPlayerEncryptedKeyRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'registerPlayerEncryptedKeyRequest' when calling PlayersAuthenticationApi->RegisterKey");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<RegisterPlayerEncryptedKeyResponse>("/iam/v1/players/register_key", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Openfort.SDK.Client.ApiResponse<RetrievePlayerEncryptedKeyResponse> localVarResponse = RetrieveKeyWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Openfort.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of RetrievePlayerEncryptedKeyResponse</returns>
        public Openfort.SDK.Client.ApiResponse<RetrievePlayerEncryptedKeyResponse> RetrieveKeyWithHttpInfo()
        {
            Openfort.SDK.Client.RequestOptions localVarRequestOptions = new Openfort.SDK.Client.RequestOptions();
        ...
        {
            Openfort.SDK.Client.ApiResponse<RetrievePlayerEncryptedKeyResponse> localVarResponse = await RetrieveKeyWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetrievePlayerEncryptedKeyResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<RetrievePlayerEncryptedKeyResponse>> RetrieveKeyWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<RetrievePlayerEncryptedKeyResponse>("/iam/v1/players/retrieve_key", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

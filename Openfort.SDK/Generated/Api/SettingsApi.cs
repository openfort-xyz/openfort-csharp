...
namespace Openfort.SDK.Api
{
    ...
    public partial class SettingsApi : IDisposable, ISettingsApi
    {
        ...
        /// <returns></returns>
        public SettingsApi(Openfort.SDK.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SettingsApi(HttpClient client, Openfort.SDK.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public SettingsApi(Openfort.SDK.Client.ISynchronousClient client, Openfort.SDK.Client.IAsynchronousClient asyncClient, Openfort.SDK.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="Openfort.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public Openfort.SDK.Client.ApiResponse<Object> RemoveWebhookWithHttpInfo()
        {
            Openfort.SDK.Client.RequestOptions localVarRequestOptions = new Openfort.SDK.Client.RequestOptions();
        ...
        {
            await RemoveWebhookWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Object>> RemoveWebhookWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/v1/settings/webhook", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="settingsWebhookUpdateRequest"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Openfort.SDK.Client.ApiResponse<Object> UpdateWebhookWithHttpInfo(SettingsWebhookUpdateRequest settingsWebhookUpdateRequest)
        {
            // verify the required parameter 'settingsWebhookUpdateRequest' is set
            if (settingsWebhookUpdateRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'settingsWebhookUpdateRequest' when calling SettingsApi->UpdateWebhook");
        ...
        {
            await UpdateWebhookWithHttpInfoAsync(settingsWebhookUpdateRequest, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Openfort.SDK.Client.ApiResponse<Object>> UpdateWebhookWithHttpInfoAsync(SettingsWebhookUpdateRequest settingsWebhookUpdateRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'settingsWebhookUpdateRequest' is set
            if (settingsWebhookUpdateRequest == null)
                throw new Openfort.SDK.Client.ApiException(400, "Missing required parameter 'settingsWebhookUpdateRequest' when calling SettingsApi->UpdateWebhook");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v1/settings/webhook", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
